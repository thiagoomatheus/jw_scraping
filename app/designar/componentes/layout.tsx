export default function Layout( { quantidadeDeSemanas }: {quantidadeDeSemanas: number}) {
    return (
        <label className="flex flex-col justify-start items-center gap-5">
            ...
            <input className="bg-yellow-500 p-2 rounded-lg text-white shadow-lg font-bold" required type="radio" name="layout" value={quantidadeDeSemanas === 1 ? 'unico' : quantidadeDeSemanas === 2 ? 'quinzenal' : 'mensal_padrao'} />
        </label>
    )
}